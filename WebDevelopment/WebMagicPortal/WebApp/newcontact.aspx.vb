...
namespace PageTemplate
	public class newcontact 	
	   ...
	   public chkaddresscopy as checkbox
	   public haddress, hcity, hstate, hzip, maddress, mcity, mstate, mzip as textbox
...
'-Buttons
 	public sub	ClientOnChange(sender As Object, e As EventArgs)
 		if chkaddresscopy.checked = true then
 			maddress.text = haddress.text
 			mcity.text = hcity.text
 			mstate.text = hstate.text
 			mzip.text= hzip.text
 		end if
 	end sub	
 	...
 	public sub	btn_savecontact(sender As Object, e As EventArgs)
  	...
  	public sub	btn_addlisting(sender As Object, e As EventArgs)
 	end sub	
