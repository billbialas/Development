<%@ Page language="vb" Codebehind="addeditcmp.aspx.vb" AutoEventWireup="false" Inherits="PageTemplate.addeditcmp" Debug="false" trace="false" enableEventValidation="false"  validateRequest="false"  %>
...
<body onload="countdown();" onmousemove="timer=start" onclick="timer=start" onkeyup="timer=start">
	<form id="forms1a" runat="server" enctype="multipart/form-data" method="post">
		<table cellpadding=0 cellspacing=0 border=0 width=100% id="HeaderLD">
	   	    <tr>  				                
                <td class=pgheaders width=18%>Add/Edit Email Campaigns</td>
            </tr>
 		</table>
 			      	    ...
 			      	    <tr>
 			      		    <td>
 			      		 	    <asp:panel id="pnlgeneral" runat=server visible=false >
										...
										<asp:panel id='pnlneedtodelete' runat=server visible=false>
