...
{
      string imageFolder = "~/";
			///string imageFolder = Convert.ToString(HttpContext.Current.Session["uimgdir"]);
        int maxWidth = 100;
        int maxHeight= 100;
        ...
        ///System.Web.HttpContext.Current.Response.Write(System.Web.HttpContext.Current.Server.MapPath(ResolveUrl(imageFolder)));
    
        string folder = 
        System.Web.HttpContext.Current.Server.MapPath(ResolveUrl(imageFolder));
