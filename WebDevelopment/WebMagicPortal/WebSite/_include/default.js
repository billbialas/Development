$(document).ready(
		...
		function prepDisclosureBoxes()
		{
				...
				$('.disclosure-title').wrap('<a href="#" class="toggleA" title="click to open"></a>');
			}
	...
	{ 
		...
		var temp = window.open(sURL, windowName, "height=" + nHeight + ",width=" + nWidth + ",resizable=yes,status=no,toolbar=" + (toolBar == true ? "yes" : 
"no") + ",menubar=" + (menuOn == true ? "yes" : "no") + ",location=" + (locationOn == true ? "yes" : "no") + ",scrollbars=" + (bScroll == true ? "yes" : 
"no")); 
		temp.opener = self; 
	} 
